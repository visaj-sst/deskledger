...
async function insertCities() {
  try {
    for (const { state, cities } of indianCities) {
      ...
      if (!stateDoc) {
        console.warn(`State "${state}" not found in the database. Skipping.`);
        continue;
      }
      ...
      console.log(`Cities for state "${state}" inserted successfully.`);
    }
  } catch (err) {
    console.error("Error inserting cities:", err.message);
  }
}
