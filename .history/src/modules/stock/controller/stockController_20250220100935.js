...
// Read stock symbols from stocks.json
...
// Fetch stock prices for an array of symbols (batch)
const fetchStockPricesBatch = async (symbolsBatch) => {
  try {
    const symbolString = symbolsBatch.join(",");
    console.log("Fetching quotes for batch: ", symbolString);
...
// Fetch stock prices for all symbols using batching
