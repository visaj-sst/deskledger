...
export const createStock = async (req, res) => {
  ...
  }; =>> along with all these response, I also want sellPrice, buyPrice, buyDate, sellDate, currentPrice of the stock and all the other relevant information : export const getStockData = async (req, res) => { 
    try {
